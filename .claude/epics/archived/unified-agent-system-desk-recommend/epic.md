...
- [x] #640 - Extend DeskDeps with optional scan data fields (parallel: true)
- [x] #641 - Add build_cleaned_domain_assessment to _parsing.py (parallel: true)
- [x] #642 - Create 6 recommendation prompts (parallel: true)
- [x] #643 - Trend + Volatility desk recommendation agents (parallel: true, depends: #640, #641, #642)
- [x] #644 - Flow + Fundamental desk recommendation agents (parallel: true, depends: #640, #641, #642)
- [x] #645 - Risk + Contrarian desk recommendation agents (parallel: true, depends: #640, #641, #642)
