...
Shared helpers used by desk, synthesis, and recommendation agents:
...
- ``render_context_block`` — flat key-value context renderer for agent prompts
...
def render_context_block(
    ...
    # Data-availability note — enrichment data is never available (OpenBB removed)
    lines.append("")
    lines.append(
