...
class TestRegistryMatchesSource:
    ...
    def test_registry_count(self) -> None:
        """Registry should contain the expected number of functions (79)."""
        assert len(MATH_FUNCTION_REGISTRY) == 79, (
            f"Expected 79 functions in registry, got {len(MATH_FUNCTION_REGISTRY)}"
        )
