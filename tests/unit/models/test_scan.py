...
class TestIndicatorSignals:
    ...
    def test_exactly_77_model_fields(self) -> None:
        """IndicatorSignals has exactly 77 model fields.

        Breakdown: 15 core + 40 DSE + 2 liquidity + 4 native quant
        + 3 vol surface + 1 hurst + 2 ML vol + 2 ML regime
        + 2 ML GBM regime + 6 ML flow anomaly.
        """
        assert len(IndicatorSignals.model_fields) == 77
