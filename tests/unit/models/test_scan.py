...
class TestIndicatorSignals:
    ...
    def test_exactly_76_model_fields(self) -> None:
        """IndicatorSignals has exactly 76 model fields.

        Breakdown: 19 core + 40 DSE + 2 liquidity + 4 native quant
        + 3 vol surface + 1 hurst + 3 ML vol + 2 ML regime
