  ...
  <div class="app-layout">
    <nav class="app-nav">
      ...
      <div class="nav-links">
        ...
        <RouterLink to="/agency" class="nav-link" data-testid="nav-link-agency">Agency</RouterLink>
        <RouterLink to="/desks" class="nav-link" data-testid="nav-link-desks">Desks</RouterLink>
      </div>
    </nav>
    <main class="app-main">
      <RouterView />
